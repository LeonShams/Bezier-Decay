...
For an interactive curve visit https://www.desmos.com/calculator/njwcvlyjqo. Once the desired curve has been created then enter the values on the left side of the screen into the bezier curve.
```
x_0 = 0 # Staring x
y_0 = 1 # Staring y
x_1 = 0.275
